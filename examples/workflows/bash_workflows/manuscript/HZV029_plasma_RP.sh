...
experiment=~/Analyses/HZV029_plasma_RP_neg2/
...
pcpfm assemble -o $working_dir -j HZV029_plasma_RP_neg2 -s ./sequence_files/HZV029_Plasma_w_reruns.csv  --filter ../../../filters/rpneg.json --name_field "File Name"
...
pcpfm l1b_annotate -i $experiment -em MoNA_HMDB_LMSD_annotated_for_analysis -nm RP_neg_with_auth_stds --targets=/Users/mitchjo/PythonCentricPipelineForMetabolomics/examples/auth_std_libraries/auth_std_RP_neg_12_01_2024_JM_wMS2.csv
pcpfm l1a_annotate -i $experiment -em RP_neg_with_auth_stds -nm RP_neg_with_auth_stds_MS2 --targets=/Users/mitchjo/PythonCentricPipelineForMetabolomics/examples/auth_std_libraries/auth_std_RP_neg_12_01_2024_JM_wMS2.csv
