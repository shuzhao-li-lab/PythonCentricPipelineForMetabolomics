...
experiment=~/Analyses/HZV029_plasma_RP_neg/
...
pcpfm assemble -o $working_dir -j HZV029_plasma_RP_neg -s ./sequence_files/HZV029_Plasma_w_reruns.csv  --filter /Users/mitchjo/Projects/PythonCentricPipelineForMetabolomics/pcpfm/filters/rpneg.json --name_field "File Name"
