...
experiment=../Analyses/checkmate_tof/
...
pcpfm assemble -o $working_dir -j checkmate_tof -s /Users/mitchjo/Datasets/ForPCPFM/CHECKMATE/TOF/sequence.csv --name_field "File Name"
