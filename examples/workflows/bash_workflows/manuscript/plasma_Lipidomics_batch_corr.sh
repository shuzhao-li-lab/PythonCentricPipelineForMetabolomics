...
experiment=../Analyses/Plasma_Lipidomics_batch_corr/
...
pcpfm assemble -o $working_dir -j Plasma_Lipidomics_batch_corr -s /Users/mitchjo/Documents/pcpfm_submission/supplemental/R01_w_reruns.csv --filter /Users/mitchjo/Projects/PythonCentricPipelineForMetabolomics/pcpfm/filters/rpneg.json --name_field "File Name"
