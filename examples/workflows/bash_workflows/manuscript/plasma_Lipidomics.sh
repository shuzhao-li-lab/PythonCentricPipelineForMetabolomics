...
experiment=../Analyses/Plasma_Lipidomics/
...
#pcpfm assemble -o $working_dir -j Plasma_Lipidomics -s /Users/mitchjo/Documents/pcpfm_submission/supplemental/ForMcGill/RP_neg/RP_neg_subset_sequence.csv --filter /Users/mitchjo/Projects/PythonCentricPipelineForMetabolomics/pcpfm/filters/rpneg.json --name_field "File Name"
...
#pcpfm l2_annotate -i $experiment -em HMDB_LMSD_annotated_for_analysis -nm MoNA_HMDB_LMSD_annotated_for_analysis --ms2_dir=/Users/mitchjo/Datasets/ForPCPFM/AcquireX_Datasets/Plasma_5_min_RPneg/Pooled/
#pcpfm l1b_annotate -i $experiment -em MoNA_HMDB_LMSD_annotated_for_analysis -nm RP_neg_with_auth_stds --targets=/Users/mitchjo/Projects/PythonCentricPipelineForMetabolomics/examples/auth_std_libraries/auth_std_RP_neg_12_01_2024_JM_wMS2.csv
#pcpfm l1a_annotate -i $experiment -em RP_neg_with_auth_stds -nm RP_neg_with_auth_stds_MS2 --targets=/Users/mitchjo/Projects/PythonCentricPipelineForMetabolomics/examples/auth_std_libraries/auth_std_RP_neg_12_01_2024_JM_wMS2.csv

#pcpfm generate_output -i $experiment -em RP_neg_with_auth_stds_MS2 -tm for_analysis 
