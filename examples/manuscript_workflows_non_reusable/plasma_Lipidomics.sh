...
pcpfm assemble -o $working_dir -j Plasma_Lipidomics -s /Users/mitchjo/Documents/pcpfm_submission/supplemental/R01_w_reruns.csv --filter /Users/mitchjo/Projects/PythonCentricPipelineForMetabolomics/pcpfm/filters/rpneg.json --name_field "File Name"
...
pcpfm MS2_annotate -i $experiment -em HMDB_LMSD_annotated_for_analysis -nm MoNA_HMDB_LMSD_annotated_for_analysis --ms2_dir=/Users/mitchjo/Datasets/ForPCPFM/AcquireX_Datasets/Plasma_5_min_RPneg/Pooled/
