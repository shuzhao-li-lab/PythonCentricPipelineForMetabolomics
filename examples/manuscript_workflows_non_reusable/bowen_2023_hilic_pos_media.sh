...
experiment=../Analyses/Bowen_Hilic_pos_media/
...
pcpfm assemble -o $working_dir -j Bowen_Hilic_pos_media -s /Users/mitchjo/Datasets/ForPCPFM/Bowen/CellMedia/sequence.csv --name_field "File Name"
