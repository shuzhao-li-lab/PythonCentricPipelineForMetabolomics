...
PARAMETERS = {
    ...
    "annot_rt_tolerance": 20,
    "khipu_mz_tolerance": 5,
    "khipu_rt_tolerance": 20,
    "mode": None,
    ...
    "msp_files_pos": "annotation_sources/MoNA-export-LC-MS-MS_Negative_Mode.msp",
    "msp_files_neg": "annotation_sources/MoNA-export-LC-MS-MS_Positive_Mode.msp",
    "ms2_dir": None,
