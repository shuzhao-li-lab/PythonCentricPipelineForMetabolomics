...
>>>>>>> refs/remotes/origin/main
    ...
    def L2_annotate(params):
        ...
        - **--msp_files**: Designate the path to the MSP files to use.
        - **--ms2_dir**: Specify the path with MS2 acquisitions.
        - **--annot_mz_tolerance**: PPM cutoff for the precursor ion search.
        - **--annot_rt_tolerance**: Time cutoff, in seconds, for the precursor ion search.
        - **--ms2_similarity_metric**: Name of any matchms method for comparing MS2 spectra.
        - **--ms2_min_peak**: Minimum number of matching peaks required for an MS2 match.
    ...
    def L1_annotate(params):
        ...
        - **--annot_mz_tolerance**: the ppm cutoff for the precursor ion search
        - **--annot_rt_tolerance**: the rtime cutoff, in sec, for the precursor ion search

        ..

        - This requires passing -i with the experiment's path. 
        - This requires passing -tm with the table's moniker to annotate, or
        - This requires passing -em with the empCpd's moniker to annotate,and
        - This requires passing -nm with the new moniker for the table or empcpd list.
